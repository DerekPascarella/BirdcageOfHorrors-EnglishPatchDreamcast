...
![#f03c15](https://via.placeholder.com/15/f03c15/f03c15.png) **NOTICE:** _Numerous typos have been identified since the v1.0 release, all visbile in the <a href="https://github.com/DerekPascarella/BirdcageOfHorrors-EnglishPatchDreamcast/issues">issues section</a>. An updated v1.1 release will be forthcoming, though an exact timeframe is yet to be determined._
<br><br>
